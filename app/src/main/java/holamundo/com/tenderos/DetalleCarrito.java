...
public class DetalleCarrito extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lblPrecioCarrito.setText(String.format("$%s", precio));
        lblPrecioTotal.setText(String.format("$%s", precio * cantidad));
        lblCantidadCarrito.setText(String.format("%s %s", cantidad, unidad));
